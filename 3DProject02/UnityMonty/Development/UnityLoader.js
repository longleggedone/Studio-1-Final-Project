...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'UnityMonty.data';
    var REMOTE_PACKAGE_BASE = 'UnityMonty.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3851101;
      var PACKAGE_UUID = '6d8673ac-c46b-4f14-951c-d1854f6314b3';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 1071460, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(1071460, 1071632, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(1071632, 1074712, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(1074712, 2948504, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2948504, 3823476, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3823476, 3851101, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_UnityMonty.data');

    };
    Module['addRunDependency']('datafile_UnityMonty.data');
